...
if __name__ == '__main__':
    ...
    #title = 'Comparing 2 Classifications of ETo Climate (2-D Day,Weather Data)'
    title = 'Comparing 1D & 2D Classifications of ETo Climate\nFor Year 2022'
    ...
    ax[1,0].set_title( 'Pixel Diff: %' + percent + ' Cramer: N/A' )
    ...
    figure.text( 0.91, 0.6, 'ETo Project, Yachay Tech University, July 2026',
                 rotation=90, fontsize=6 )
    
    #figure.text( 0.91, 0.58, 'Source: '+ srcfile, rotation=90, fontsize=7 )
    first = '../data/2D/2022/msom_examples/0.300000_50_h9fdw_1st/0.300000_50_0.npy'
    second = '../data/1D/2022/msom/msom_examples/0.300000_30_linear_zanorm_1st/0.300000_30_0.npy'

    figure.text( 0.91, 0.19, '2D Source: '+ first, rotation=90, fontsize=6 )
    figure.text( 0.93, 0.19, '1D Source: '+ second, rotation=90, fontsize=6 )
